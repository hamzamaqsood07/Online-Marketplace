...
interface Props {
    ...
    row: {
        ...
        title: string;
        description: string;
        pictures: any[]; // Update the type accordingly
        price: number;
        quantity: number;
    };
    fetchCall: () => Promise<void>;
}

const EditItem: React.FC<Props> = ({ closeEvent, row, fetchCall }) => {
    const id = row.id;
    const [pictures, setPictures] = useState<File[]>(row.pictures);
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                } else alert('Product updation unsuccessful');
            } catch (error) {
